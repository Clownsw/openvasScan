...
public class OpenvasEngine {
    ...
    static {
        OPENVAS_COMMAND_PARSE_MAP = new HashMapBuilder<OpenvasCommand, OpenvasCommandParse<?>>(12)
                ...
                .put(OpenvasCommand.GET_TARGETS, new OpenvasCommandGetTargets())
                .put(OpenvasCommand.GET_PORT_RANGE, new OpenvasCommandGetPortRange())
                .put(OpenvasCommand.GET_SCANNERS, new OpenvasCommandGetScanners())
                .put(OpenvasCommand.GET_REPORT, new OpenvasCommandGetReport())
                ...
                .put(OpenvasCommand.GET_RESULT, new OpenvasCommandGetResult())
                .get();
    }
